    ...
    <>
        ...
        <AppBar color="background" height="70px">
          <Toolbar disableGutters>
            <Container maxWidth="xl">
              ...
              >
                <NextLink href="/">
                  <Link href=""><img src="/logo.svg" alt="Bear Brotherhood" /></Link>
                </NextLink>
                <NextLink href="/cart">
                  <Link href="/cart">
                    <Box>
      ...
      <footer>
        ...
        >
          ...
          <Typography textAlign="center" variant="body1">Bear Brotherhood is a Shopify demo that uses <span style={{fontWeight: 600}}>Marketplace Kit</span> to build <span style={{fontWeight: 600}}>Marketplaces</span></Typography>
        </Stack>
      </footer>
    </>
  );
